  ...
  return (
    <>
      <div className="flex flex-col w-full gap-20 relative ">
        <div className="w-full  flex mx-auto   items-center justify-between  max-1010:flex-col  max-1010px:gap-12 max-1010px:px-0 max-1010px:max-w-[543px]  ">
          <div className="flex justify-center  flex-1 max-1010:w-full max-1010:justify-start">
            <TwitterLogo className="w-[300px] h-[270px] max-1010:w-10  max-1010:h-10" />
          </div>
          <Authorization />
        </div>
        <AuthorizationFooter />
